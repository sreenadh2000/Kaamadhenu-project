...
//   const { fetchUserByIdForAdmin, adminSelectedUser, loading, error } =
//     useUserStore();

//   const user = adminSelectedUser?.user || {};
//   const orders = adminSelectedUser?.orders || [];
//   const addresses = adminSelectedUser?.addresses || [];
...
//     fetchUserByIdForAdmin(id);
//     // };
//     // loadData();
//   }, [id, fetchUserByIdForAdmin]);

//   console.log("fetch User By Id selected User :", adminSelectedUser);
...
//     if (!adminSelectedUser?.orders) return [];
//     const start = (currentPage - 1) * perPage;
//     return adminSelectedUser.orders.slice(start, start + perPage);
//   }, [adminSelectedUser, currentPage, perPage]);
...
//           </button>
//           <AdminHeaderWrapper
//             title={`${adminSelectedUser?.user?.firstName || ""} ${adminSelectedUser?.user?.lastName || ""}`}
...
//                 {[
//                   { key: "firstName", label: "First Name", icon: null },
//                   { key: "lastName", label: "Last Name", icon: null },
//                   {
//                     key: "email",
//                     label: "Email Address",
//                     icon: <Mail size={14} />,
...
//                         {form[field.key] || "—"}
//                         {/* {adminSelectedUser?.user?.[field.key] || "—"} */}
//                       </p>
//                     )}
//                   </div>
//                 ))}
...
//                     Lifetime Orders: {adminSelectedUser.orders.length}
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               <Pagination
//                 totalItems={adminSelectedUser.orders.length}
